                        ...
                        if (productRepository.count() == 0) {
                                ...
                                productRepository.saveAll(List.of(
                                                ...
                                                Product.builder().name("Ergonomic Gaming Chair").category("Furniture")
                                                                ...
                                                                .imageUrl("https://m.media-amazon.com/images/I/61NlUu1lS2L.jpg")
                                                                .build(),
                                                ...
                                                Product.builder().name("RGB Mousepad XL").category("Peripherals")
                                                                ...
                                                                .imageUrl("https://m.media-amazon.com/images/I/71s8L+hS5AL.jpg")
                                                                .build(),
                                                ...
                                                Product.builder().name("Wireless Pro Controller")
                                                                ...
                                                                .imageUrl("https://m.media-amazon.com/images/I/61G+Gz1i7ZL.jpg")
                                                                .build()));
                        }
